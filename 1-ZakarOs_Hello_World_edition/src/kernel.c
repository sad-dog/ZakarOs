...
void kernel_entry()
{
  ...
  */
  print_string("Welcom,This is ZAKAROS hello world edition,so here is a simple int bellow");
  print_new_line();
  print_int(123);
  print_new_line();
  print_string("Thanks,the source code are in the src file!!,BUT REALLY WHY YOU SPEND YOUR TIME FOR NOTHING,GO TO THE SRC FILE!!");
  print_new_line();
  print_string("so yes this is a hello world edition so,HELLO WORLD!!");
}
